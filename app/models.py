...
class Group(models.Model):
	...
	Name = models.CharField(max_length=50)
	Properties = models.ManyToManyField(Property, blank=True)
	ParentGroup = models.ForeignKey("self", blank=True, null=True, on_delete=models.CASCADE)
	CreatedOn = models.DateTimeField(auto_now_add=True)
	ModifiedOn = models.DateTimeField(auto_now_add=True)
...
class Interface(models.Model):
	Id = ShortUUIDField(unique=True, primary_key=True, blank=False, editable=False)
	Name = models.CharField(max_length=50)
	Editor = models.ForeignKey(Property, null=True, related_name="editor", on_delete=models.CASCADE)
	Monitor = models.ForeignKey(Property, null=True, on_delete=models.CASCADE)
	CreatedOn = models.DateTimeField(auto_now_add=True)
	ModifiedOn = models.DateTimeField(auto_now_add=True)
